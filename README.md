...
11) Create a GitHub repo to manage your CI/CD Front-End to for your website + GitHub Actions
   ...
   - Once the code is pushed - you can now see news Actions being propagated in the Action tab of the GitHub repo.
      ...
      - When I pushed a README change and viewed the Action workflow - I got a different error this time: 'An error occurred (AccessControlListNotSupported) when calling the PutObject operation: The bucket does not allow ACLs'. So I updated the configuration of my S3 bucket to enable ACL
